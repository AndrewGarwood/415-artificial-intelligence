...
class State():
    ...
    def __init__(self, d=None):
        if d is None:
            d = {'people': [[0, 0], [0, 0]],  # list of lists that represents. . . counts of missionaries/cannibals?
                 'boat': LEFT}                # left list is for missionaries; right list is for cannibals
        self.d = d                            # index 0 reps count on left side and index 1 reps count on right side
