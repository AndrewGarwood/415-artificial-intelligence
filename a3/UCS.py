...
print("\nWelcome to UCS, by Andrew Garwood!")
    ...
    # EACH SUCCESSOR.***
        for operator in Problem.OPERATORS:
            if operator.precond(S):
                ...
                successor_weight = S.edge_distance(successor) + g[S]
                if successor in OPEN:
                    if successor_weight < g[successor]:
                        g[successor] = successor_weight
                        OPEN.insert(successor, successor_weight)
                        BACKLINKS[successor] = S
                elif successor not in CLOSED:
                    g[successor] = successor_weight
                    OPEN.insert(successor, g[successor])
                    BACKLINKS[successor] = S
